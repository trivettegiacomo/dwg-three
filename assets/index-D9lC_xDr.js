 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var an,Gl,Qn,Br,kr,co,Vg,ls,fa,Gg,dr,Ti,Wg,Xg=function(){return an||typeof window<"u"&&(an=window.gsap)&&an.registerPlugin&&an},Yg=1,to=[],lt=[],Yi=[],da=Date.now,Ph=function(e,t){return t},bb=function(){var e=fa.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,lt),i.push.apply(i,Yi),lt=n,Yi=i,Ph=function(o,a){return t[o](a)}},Wr=function(e,t){return~Yi.indexOf(e)&&Yi[Yi.indexOf(e)+1][t]},pa=function(e){return!!~Gg.indexOf(e)},Mn=function(e,t,n,i,r){return e.addEventListener(t,n,{passive:i!==!1,capture:!!r})},yn=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},_l="scrollLeft",vl="scrollTop",Dh=function(){return dr&&dr.isPressed||lt.cache++},ac=function(e,t){var n=function i(r){if(r||r===0){Yg&&(Qn.history.scrollRestoration="manual");var o=dr&&dr.isPressed;r=i.v=Math.round(r)||(dr&&dr.iOS?1:0),e(r),i.cacheID=lt.cache,o&&Ph("ss",r)}else(t||lt.cache!==i.cacheID||Ph("ref"))&&(i.cacheID=lt.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},Rn={s:_l,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:ac(function(s){return arguments.length?Qn.scrollTo(s,Zt.sc()):Qn.pageXOffset||Br[_l]||kr[_l]||co[_l]||0})},Zt={s:vl,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:Rn,sc:ac(function(s){return arguments.length?Qn.scrollTo(Rn.sc(),s):Qn.pageYOffset||Br[vl]||kr[vl]||co[vl]||0})},On=function(e,t){return(t&&t._ctx&&t._ctx.selector||an.utils.toArray)(e)[0]||(typeof e=="string"&&an.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},wb=function(e,t){for(var n=t.length;n--;)if(t[n]===e||t[n].contains(e))return!0;return!1},Kr=function(e,t){var n=t.s,i=t.sc;pa(e)&&(e=Br.scrollingElement||kr);var r=lt.indexOf(e),o=i===Zt.sc?1:2;!~r&&(r=lt.push(e)-1),lt[r+o]||Mn(e,"scroll",Dh);var a=lt[r+o],l=a||(lt[r+o]=ac(Wr(e,n),!0)||(pa(e)?i:ac(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,a||(l.smooth=an.getProperty(e,"scrollBehavior")==="smooth"),l},Lh=function(e,t,n){var i=e,r=e,o=da(),a=o,l=t||50,c=Math.max(500,l*3),u=function(_,g){var m=da();g||m-o>l?(r=i,i=_,a=o,o=m):n?i+=_:i=r+(_-r)/(m-a)*(o-a)},h=function(){r=i=n?0:i,a=o=0},f=function(_){var g=a,m=r,p=da();return(_||_===0)&&_!==i&&u(_),o===a||p-a>c?0:(i+(n?m:-m))/((n?p:o)-g)*1e3};return{update:u,reset:h,getVelocity:f}},qo=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},Cp=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},qg=function(){fa=an.core.globals().ScrollTrigger,fa&&fa.core&&bb()},Kg=function(e){return an=e||Xg(),!Gl&&an&&typeof document<"u"&&document.body&&(Qn=window,Br=document,kr=Br.documentElement,co=Br.body,Gg=[Qn,Br,kr,co],an.utils.clamp,Wg=an.core.context||function(){},ls="onpointerenter"in co?"pointer":"mouse",Vg=Wt.isTouch=Qn.matchMedia&&Qn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Qn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,Ti=Wt.eventTypes=("ontouchstart"in kr?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in kr?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return Yg=0},500),qg(),Gl=1),Gl};Rn.op=Zt;lt.cache=0;var Wt=function(){function s(t){this.init(t)}var e=s.prototype;return e.init=function(n){Gl||Kg(an)||console.warn("Please gsap.registerPlugin(Observer)"),fa||qg();var i=n.tolerance,r=n.dragMinimum,o=n.type,a=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,h=n.onStop,f=n.onStopDelay,d=n.ignore,_=n.wheelSpeed,g=n.event,m=n.onDragStart,p=n.onDragEnd,T=n.onDrag,S=n.onPress,v=n.onRelease,w=n.onRight,R=n.onLeft,b=n.onUp,P=n.onDown,y=n.onChangeX,M=n.onChangeY,C=n.onChange,U=n.onToggleX,H=n.onToggleY,V=n.onHover,j=n.onHoverEnd,W=n.onMove,Y=n.ignoreCheck,G=n.isNormalizer,oe=n.onGestureStart,L=n.onGestureEnd,ge=n.onWheel,Ue=n.onEnable,Ze=n.onDisable,Fe=n.onClick,Z=n.scrollSpeed,fe=n.capture,ae=n.allowClicks,be=n.lockAxis,we=n.onLockAxis;this.target=a=On(a)||kr,this.vars=n,d&&(d=an.utils.toArray(d)),i=i||1e-9,r=r||0,_=_||1,Z=Z||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Qn.getComputedStyle(co).lineHeight)||22);var ke,nt,Ve,D,Ye,Ee,qe,O=this,Je=0,X=0,N=n.passive||!u&&n.passive!==!1,re=Kr(a,Rn),ve=Kr(a,Zt),A=re(),x=ve(),F=~o.indexOf("touch")&&!~o.indexOf("pointer")&&Ti[0]==="pointerdown",J=pa(a),Q=a.ownerDocument||Br,K=[0,0,0],de=[0,0,0],ne=0,xe=function(){return ne=da()},te=function(Ie,je){return(O.event=Ie)&&d&&wb(Ie.target,d)||je&&F&&Ie.pointerType!=="touch"||Y&&Y(Ie,je)},ue=function(){O._vx.reset(),O._vy.reset(),nt.pause(),h&&h(O)},pe=function(){var Ie=O.deltaX=Cp(K),je=O.deltaY=Cp(de),Me=Math.abs(Ie)>=i,Ge=Math.abs(je)>=i;C&&(Me||Ge)&&C(O,Ie,je,K,de),Me&&(w&&O.deltaX>0&&w(O),R&&O.deltaX<0&&R(O),y&&y(O),U&&O.deltaX<0!=Je<0&&U(O),Je=O.deltaX,K[0]=K[1]=K[2]=0),Ge&&(P&&O.deltaY>0&&P(O),b&&O.deltaY<0&&b(O),M&&M(O),H&&O.deltaY<0!=X<0&&H(O),X=O.deltaY,de[0]=de[1]=de[2]=0),(D||Ve)&&(W&&W(O),Ve&&(m&&Ve===1&&m(O),T&&T(O),Ve=0),D=!1),Ee&&!(Ee=!1)&&we&&we(O),Ye&&(ge(O),Ye=!1),ke=0},Le=function(Ie,je,Me){K[Me]+=Ie,de[Me]+=je,O._vx.update(Ie),O._vy.update(je),c?ke||(ke=requestAnimationFrame(pe)):pe()},Re=function(Ie,je){be&&!qe&&(O.axis=qe=Math.abs(Ie)>Math.abs(je)?"x":"y",Ee=!0),qe!=="y"&&(K[2]+=Ie,O._vx.update(Ie,!0)),qe!=="x"&&(de[2]+=je,O._vy.update(je,!0)),c?ke||(ke=requestAnimationFrame(pe)):pe()},me=function(Ie){if(!te(Ie,1)){Ie=qo(Ie,u);var je=Ie.clientX,Me=Ie.clientY,Ge=je-O.x,Be=Me-O.y,Ke=O.isDragging;O.x=je,O.y=Me,(Ke||(Ge||Be)&&(Math.abs(O.startX-je)>=r||Math.abs(O.startY-Me)>=r))&&(Ve=Ke?2:1,Ke||(O.isDragging=!0),Re(Ge,Be))}},He=O.onPress=function(ye){te(ye,1)||ye&&ye.button||(O.axis=qe=null,nt.pause(),O.isPressed=!0,ye=qo(ye),Je=X=0,O.startX=O.x=ye.clientX,O.startY=O.y=ye.clientY,O._vx.reset(),O._vy.reset(),Mn(G?a:Q,Ti[1],me,N,!0),O.deltaX=O.deltaY=0,S&&S(O))},I=O.onRelease=function(ye){if(!te(ye,1)){yn(G?a:Q,Ti[1],me,!0);var Ie=!isNaN(O.y-O.startY),je=O.isDragging,Me=je&&(Math.abs(O.x-O.startX)>3||Math.abs(O.y-O.startY)>3),Ge=qo(ye);!Me&&Ie&&(O._vx.reset(),O._vy.reset(),u&&ae&&an.delayedCall(.08,function(){if(da()-ne>300&&!ye.defaultPrevented){if(ye.target.click)ye.target.click();else if(Q.createEvent){var Be=Q.createEvent("MouseEvents");Be.initMouseEvent("click",!0,!0,Qn,1,Ge.screenX,Ge.screenY,Ge.clientX,Ge.clientY,!1,!1,!1,!1,0,null),ye.target.dispatchEvent(Be)}}})),O.isDragging=O.isGesturing=O.isPressed=!1,h&&je&&!G&&nt.restart(!0),Ve&&pe(),p&&je&&p(O),v&&v(O,Me)}},le=function(Ie){return Ie.touches&&Ie.touches.length>1&&(O.isGesturing=!0)&&oe(Ie,O.isDragging)},ce=function(){return(O.isGesturing=!1)||L(O)},he=function(Ie){if(!te(Ie)){var je=re(),Me=ve();Le((je-A)*Z,(Me-x)*Z,1),A=je,x=Me,h&&nt.restart(!0)}},ie=function(Ie){if(!te(Ie)){Ie=qo(Ie,u),ge&&(Ye=!0);var je=(Ie.deltaMode===1?l:Ie.deltaMode===2?Qn.innerHeight:1)*_;Le(Ie.deltaX*je,Ie.deltaY*je,0),h&&!G&&nt.restart(!0)}},ee=function(Ie){if(!te(Ie)){var je=Ie.clientX,Me=Ie.clientY,Ge=je-O.x,Be=Me-O.y;O.x=je,O.y=Me,D=!0,h&&nt.restart(!0),(Ge||Be)&&Re(Ge,Be)}},Te=function(Ie){O.event=Ie,V(O)},De=function(Ie){O.event=Ie,j(O)},ot=function(Ie){return te(Ie)||qo(Ie,u)&&Fe(O)};nt=O._dc=an.delayedCall(f||.25,ue).pause(),O.deltaX=O.deltaY=0,O._vx=Lh(0,50,!0),O._vy=Lh(0,50,!0),O.scrollX=re,O.scrollY=ve,O.isDragging=O.isGesturing=O.isPressed=!1,Wg(this),O.enable=function(ye){return O.isEnabled||(Mn(J?Q:a,"scroll",Dh),o.indexOf("scroll")>=0&&Mn(J?Q:a,"scroll",he,N,fe),o.indexOf("wheel")>=0&&Mn(a,"wheel",ie,N,fe),(o.indexOf("touch")>=0&&Vg||o.indexOf("pointer")>=0)&&(Mn(a,Ti[0],He,N,fe),Mn(Q,Ti[2],I),Mn(Q,Ti[3],I),ae&&Mn(a,"click",xe,!0,!0),Fe&&Mn(a,"click",ot),oe&&Mn(Q,"gesturestart",le),L&&Mn(Q,"gestureend",ce),V&&Mn(a,ls+"enter",Te),j&&Mn(a,ls+"leave",De),W&&Mn(a,ls+"move",ee)),O.isEnabled=!0,O.isDragging=O.isGesturing=O.isPressed=D=Ve=!1,O._vx.reset(),O._vy.reset(),A=re(),x=ve(),ye&&ye.type&&He(ye),Ue&&Ue(O)),O},O.disable=function(){O.isEnabled&&(to.filter(function(ye){return ye!==O&&pa(ye.target)}).length||yn(J?Q:a,"scroll",Dh),O.isPressed&&(O._vx.reset(),O._vy.reset(),yn(G?a:Q,Ti[1],me,!0)),yn(J?Q:a,"scroll",he,fe),yn(a,"wheel",ie,fe),yn(a,Ti[0],He,fe),yn(Q,Ti[2],I),yn(Q,Ti[3],I),yn(a,"click",xe,!0),yn(a,"click",ot),yn(Q,"gesturestart",le),yn(Q,"gestureend",ce),yn(a,ls+"enter",Te),yn(a,ls+"leave",De),yn(a,ls+"move",ee),O.isEnabled=O.isPressed=O.isDragging=!1,Ze&&Ze(O))},O.kill=O.revert=function(){O.disable();var ye=to.indexOf(O);ye>=0&&to.splice(ye,1),dr===O&&(dr=0)},to.push(O),G&&pa(a)&&(dr=O),O.enable(g)},Eb(s,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),s}();Wt.version="3.13.0";Wt.create=function(s){return new Wt(s)};Wt.register=Kg;Wt.getAll=function(){return to.slice()};Wt.getById=function(s){return to.filter(function(e){return e.vars.id===s})[0]};Xg()&&an.registerPlugin(Wt);/*!
...
}`,p_="./";Jn.registerPlugin(ft,Rs);const m_=Rs.create({wrapper:"#smooth-wrapper",content:"#smooth-content",smooth:1.5,effects:!0});m_.scrollTo(0,!0);m_.paused(!0);const fc=document.querySelector(".scroll-indicator");let tm=!1;const Tc=new Dm;Tc.onLoad=()=>{tm||(tm=!0,window.parent.postMessage({type:"threejs-scene-loaded"},"*"),console.log("loading complete"))};Tc.onProgress=(s,e,t)=>{const n=Math.round(e/t*100);window.parent.postMessage({type:"threejs-scene-progress",progress:n},"*"),console.log(`loading ${n}% (${e}/${t})`)};const si=new tv;si.background=new Xe(0);const tw=new rf(300,300,15),nw=new Ki({side:Dn,uniforms:{topColor:{value:new Xe(0)},bottomColor:{value:new Xe(16777215)},gradientSharpness:{value:8},gradientOffset:{value:-.05}},vertexShader:Qb,fragmentShader:ew}),iw=new Pn(tw,nw);si.add(iw);const rw=new Lv(16777215,.5);si.add(rw);const yr=new af(16774893,400);yr.position.set(0,8,15);yr.angle=Math.PI/6;yr.penumbra=.2;yr.decay=2;yr.distance=30;yr.castShadow=!0;yr.target.position.set(0,.5,0);si.add(yr.target);si.add(yr);const ni=new z(0,14,-170),Mr=new af(16774893,2500);Mr.position.set(ni.x,ni.y+8,ni.z+2);Mr.angle=Math.PI/2;Mr.penumbra=.2;Mr.decay=2;Mr.distance=30;Mr.castShadow=!0;Mr.target.position.set(ni.x,ni.y,ni.z);si.add(Mr.target);si.add(Mr);const Bf=new Um(16774893,400);Bf.position.set(0,15,15);Bf.castShadow=!0;si.add(Bf);const sw=new RT(Tc);sw.load(`${p_}gltf/frame_wall.glb`,s=>{s.scene.traverse(e=>{e.isMesh&&(e.name==="wall"&&(e.receiveShadow=!0),e.name==="frame"&&(e.castShadow=!0),e.name==="passpartout"&&(e.receiveShadow=!0),(e.name==="mount"||e.name==="mount001")&&(e.castShadow=!0))}),s.scene.position.set(0,0,0),si.add(s.scene)},void 0,s=>{console.error("Errore nel caricamento del modello:",s)});const kf=new Xr(window.innerWidth,window.innerHeight,{minFilter:Cn,magFilter:Cn,format:Xh}),Ui=new dn(75,window.innerWidth/window.innerHeight,.1,1e3),ow=new Dr(new z(0,1,0),4),zf=new Ki({fragmentShader:Zb,vertexShader:Jb,transparent:!0,uniforms:{uTime:{value:0},uFrequency:{value:.1},uAmplitude:{value:.6},uReflectionTexture:{value:kf.texture},textureMatrix:{value:new $e}}}),g_=new Do(300,300,1024,1024);g_.rotateX(-Math.PI*.5);const Ma=new Pn(g_,zf);Ma.position.set(0,-4,-150.85);si.add(Ma);function aw(){const s=Ma.position.y;Wi.position.clone(),Wi.rotation.clone(),Ui.position.copy(Wi.position),Ui.position.y=2*s-Wi.position.y,Ui.lookAt(ni.x,ni.y,ni.z),Ui.updateMatrixWorld(),Ui.updateProjectionMatrix();const e=new $e;e.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),e.multiply(Ui.projectionMatrix),e.multiply(Ui.matrixWorldInverse),zf.uniforms.textureMatrix.value=e,Ma.visible=!1,wi.clippingPlanes=[ow],wi.setRenderTarget(kf),wi.render(si,Ui),wi.setRenderTarget(null),wi.clippingPlanes=[],Ma.visible=!0}const lw=new Im(Tc).load(`${p_}textures/cloud.png`),Ec=new Kb({texture:lw});Ec.position.set(ni.x,ni.y,ni.z);si.add(Ec);const cw=new jb({seed:5,segments:80,volume:10,bounds:new z(12,4,2),opacity:.7,speed:.2,color:new Xe("white")});Ec.add(cw);let dc=ni.z+35;const uw=10,hw=6e3;window.innerWidth<768&&(dc+=4);const Wi=new dn(75,window.innerWidth/window.innerHeight,.1,1e3);Wi.position.set(.1,0,dc);const Hf=document.createElement("div");Hf.className="spacer";Hf.style.height="calc(100vh + "+hw+"px)";document.getElementById("smooth-content").appendChild(Hf);const wi=new AT({antialias:!0});wi.setSize(window.innerWidth,window.innerHeight);wi.shadowMap.enabled=!0;wi.domElement.id="webgl";document.body.appendChild(wi.domElement);const nm=new Nv;function __(){const s=nm.getElapsedTime(),e=nm.getDelta();zf.uniforms.uTime.value=s,aw(),requestAnimationFrame(__),Ec.update(Wi,s,e),wi.render(si,Wi)}__();window.addEventListener("resize",()=>{Wi.aspect=window.innerWidth/window.innerHeight,Wi.updateProjectionMatrix(),wi.setSize(window.innerWidth,window.innerHeight),kf.setSize(window.innerWidth,window.innerHeight),Ui.aspect=window.innerWidth/window.innerHeight,Ui.updateProjectionMatrix()});function fw(s){const e=Array.from(s.childNodes);s.textContent="",e.forEach(t=>{if(t.nodeType===Node.TEXT_NODE)t.textContent.split(/(\s+)/).forEach(i=>{if(i.match(/^\s+$/))s.appendChild(document.createTextNode(i));else if(i.trim()!==""){const r=document.createElement("span");r.textContent=i,s.appendChild(r)}});else if(t.nodeType===Node.ELEMENT_NODE){const n=t.cloneNode(!1);t.textContent.split(/(\s+)/).forEach(r=>{if(r.match(/^\s+$/))n.appendChild(document.createTextNode(r));else if(r.trim()!==""){const o=document.createElement("span");o.textContent=r,n.appendChild(o)}}),s.appendChild(n)}})}let Xi=1,Vf=1,Co=!0;window.addEventListener("load",()=>{const s=document.querySelector(".intro1"),e=document.querySelector(".intro2"),t=document.querySelector(".intro3");[s,e,t].forEach(n=>fw(n)),Jn.set(".intro1 span, .intro2 span, .intro3 span",{opacity:0}),Jn.set(".intro1, .intro2, .intro3",{opacity:1}),Jn.to(".intro1 span",{opacity:1,duration:1,stagger:{each:.15,onComplete:function(){console.log("span animation complete"),Jn.to(fc,{opacity:1,duration:1}),console.log("enabling scroll"),Co=!1}},delay:.5,ease:"power1.out"})});window.addEventListener("message",s=>{s.data?.type==="start-scene-animation"&&(console.log("received start"),Jn.to(".intro1 span",{opacity:1,duration:1,stagger:{each:.15,onComplete:function(){console.log("span animation complete"),Jn.to(fc,{opacity:1,duration:1}),console.log("enabling scroll"),Co=!1}},delay:.5,ease:"power1.out"}))});const dw=1,zh=3;function v_(){console.log("Going to phase: ",Xi),Co=!0,Jn.to(fc,{opacity:0,duration:.5}),Jn.to(".intro"+Vf+" span",{opacity:0,duration:1});const s=dc+(Xi-1)/(zh-1)*(uw-dc);Jn.to(Wi.position,{z:s,duration:3,ease:"power1.inOut",onComplete:()=>{Jn.to(".intro"+Xi+" span",{opacity:1,duration:1.5,delay:0,stagger:{each:.15,onComplete:function(){}},onComplete:()=>{Co=!1,Xi===zh&&(window.parent.postMessage({type:"iframeScrolledToEnd"},"*"),console.log("iframeScrolledToEnd message")),Jn.to(fc,{opacity:1,duration:1})}})}})}function x_(){Xi<zh&&(Vf=Xi,Xi++,v_())}function y_(){Xi>dw&&(Vf=Xi,Xi--,v_())}window.addEventListener("wheel",s=>{Co||(s.deltaY>0?(console.log("scroll verso il basso"),x_()):s.deltaY<0&&(console.log("scroll verso l’alto"),y_()))});let M_=0,S_=0;window.addEventListener("touchstart",s=>{M_=s.touches[0].clientY});window.addEventListener("touchend",s=>{S_=s.changedTouches[0].clientY,pw()});function pw(){const s=M_-S_;Math.abs(s)<50||Co||(s>0?(console.log("swipe verso l’alto"),x_()):(console.log("swipe verso il basso"),y_()))}
