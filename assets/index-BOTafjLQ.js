...
void main() {
	...
	`}function NM(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Uu||l===Nu,u=l===po||l===mo;if(c||u){let h=e.get(a);const f=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return t===null&&(t=new zd(s)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const d=a.image;return c&&d&&d.height>0||u&&d&&i(d)?(t===null&&(t=new zd(s)),h=c?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function i(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function OM(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&io("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function FM(s,e,t,n){const i={},r=new WeakMap;function o(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const _ in f.attributes)e.remove(f.attributes[_]);f.removeEventListener("dispose",o),delete i[f.id];const d=r.get(f);d&&(e.remove(d),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(h,f){return i[f.id]===!0||(f.addEventListener("dispose",o),i[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const d in f)e.update(f[d],s.ARRAY_BUFFER)}function c(h){const f=[],d=h.index,_=h.attributes.position;let g=0;if(d!==null){const T=d.array;g=d.version;for(let S=0,v=T.length;S<v;S+=3){const w=T[S+0],R=T[S+1],b=T[S+2];f.push(w,R,R,b,b,w)}}else if(_!==void 0){const T=_.array;g=_.version;for(let S=0,v=T.length/3-1;S<v;S+=3){const w=S+0,R=S+1,b=S+2;f.push(w,R,R,b,b,w)}}else return;const m=new(pm(f)?xm:vm)(f,1);m.version=g;const p=r.get(h);p&&e.remove(p),r.set(h,m)}function u(h){const f=r.get(h);if(f){const d=h.index;d!==null&&f.version<d.version&&c(h)}else c(h);return r.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function BM(s,e,t){let n;function i(f){n=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function l(f,d){s.drawElements(n,d,r,f*o),t.update(d,n,1)}function c(f,d,_){_!==0&&(s.drawElementsInstanced(n,d,r,f*o,_),t.update(d,n,_))}function u(f,d,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,r,f,0,_);let m=0;for(let p=0;p<_;p++)m+=d[p];t.update(m,n,1)}function h(f,d,_,g){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<f.length;p++)c(f[p]/o,d[p],g[p]);else{m.multiDrawElementsInstancedWEBGL(n,d,0,r,f,0,g,0,_);let p=0;for(let T=0;T<_;T++)p+=d[T]*g[T];t.update(p,n,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function kM(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function zM(s,e,t){const n=new WeakMap,i=new _t;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(a);if(f===void 0||f.count!==h){let M=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",M)};var d=M;f!==void 0&&f.texture.dispose();const _=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],T=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let v=0;_===!0&&(v=1),g===!0&&(v=2),m===!0&&(v=3);let w=a.attributes.position.count*v,R=1;w>e.maxTextureSize&&(R=Math.ceil(w/e.maxTextureSize),w=e.maxTextureSize);const b=new Float32Array(w*R*4*h),P=new mm(b,w,R,h);P.type=Ai,P.needsUpdate=!0;const y=v*4;for(let C=0;C<h;C++){const U=p[C],H=T[C],V=S[C],j=w*R*4*C;for(let W=0;W<U.count;W++){const Y=W*y;_===!0&&(i.fromBufferAttribute(U,W),b[j+Y+0]=i.x,b[j+Y+1]=i.y,b[j+Y+2]=i.z,b[j+Y+3]=0),g===!0&&(i.fromBufferAttribute(H,W),b[j+Y+4]=i.x,b[j+Y+5]=i.y,b[j+Y+6]=i.z,b[j+Y+7]=0),m===!0&&(i.fromBufferAttribute(V,W),b[j+Y+8]=i.x,b[j+Y+9]=i.y,b[j+Y+10]=i.z,b[j+Y+11]=V.itemSize===4?i.w:1)}}f={count:h,texture:P,size:new dt(w,R)},n.set(a,f),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const g=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(s,"morphTargetBaseInfluence",g),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(s,"morphTargetsTextureSize",f.size)}return{update:r}}function HM(s,e,t,n){let i=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(i.get(h)!==c&&(e.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(t.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;i.get(f)!==c&&(f.update(),i.set(f,c))}return h}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}const Om=new rn,Wd=new Rm(1,1),Fm=new mm,Bm=new N0,km=new Sm,Xd=[],Yd=[],qd=new Float32Array(16),Kd=new Float32Array(9),$d=new Float32Array(4);function Uo(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=Xd[i];if(r===void 0&&(r=new Float32Array(i),Xd[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function Jt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Qt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function _c(s,e){let t=Yd[e];t===void 0&&(t=new Int32Array(e),Yd[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function VM(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function GM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;s.uniform2fv(this.addr,e),Qt(t,e)}}function WM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Jt(t,e))return;s.uniform3fv(this.addr,e),Qt(t,e)}}function XM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;s.uniform4fv(this.addr,e),Qt(t,e)}}function YM(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Jt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Qt(t,e)}else{if(Jt(t,n))return;$d.set(n),s.uniformMatrix2fv(this.addr,!1,$d),Qt(t,n)}}function qM(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Jt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Qt(t,e)}else{if(Jt(t,n))return;Kd.set(n),s.uniformMatrix3fv(this.addr,!1,Kd),Qt(t,n)}}function KM(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Jt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Qt(t,e)}else{if(Jt(t,n))return;qd.set(n),s.uniformMatrix4fv(this.addr,!1,qd),Qt(t,n)}}function $M(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function jM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;s.uniform2iv(this.addr,e),Qt(t,e)}}function ZM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Jt(t,e))return;s.uniform3iv(this.addr,e),Qt(t,e)}}function JM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;s.uniform4iv(this.addr,e),Qt(t,e)}}function QM(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function eS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;s.uniform2uiv(this.addr,e),Qt(t,e)}}function tS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Jt(t,e))return;s.uniform3uiv(this.addr,e),Qt(t,e)}}function nS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;s.uniform4uiv(this.addr,e),Qt(t,e)}}function iS(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Wd.compareFunction=dm,r=Wd):r=Om,t.setTexture2D(e||r,i)}function rS(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Bm,i)}function sS(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||km,i)}function oS(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Fm,i)}function aS(s){switch(s){case 5126:return VM;case 35664:return GM;case 35665:return WM;case 35666:return XM;case 35674:return YM;case 35675:return qM;case 35676:return KM;case 5124:case 35670:return $M;case 35667:case 35671:return jM;case 35668:case 35672:return ZM;case 35669:case 35673:return JM;case 5125:return QM;case 36294:return eS;case 36295:return tS;case 36296:return nS;case 35678:case 36198:case 36298:case 36306:case 35682:return iS;case 35679:case 36299:case 36307:return rS;case 35680:case 36300:case 36308:case 36293:return sS;case 36289:case 36303:case 36311:case 36292:return oS}}function lS(s,e){s.uniform1fv(this.addr,e)}function cS(s,e){const t=Uo(e,this.size,2);s.uniform2fv(this.addr,t)}function uS(s,e){const t=Uo(e,this.size,3);s.uniform3fv(this.addr,t)}function hS(s,e){const t=Uo(e,this.size,4);s.uniform4fv(this.addr,t)}function fS(s,e){const t=Uo(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function dS(s,e){const t=Uo(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function pS(s,e){const t=Uo(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function mS(s,e){s.uniform1iv(this.addr,e)}function gS(s,e){s.uniform2iv(this.addr,e)}function _S(s,e){s.uniform3iv(this.addr,e)}function vS(s,e){s.uniform4iv(this.addr,e)}function xS(s,e){s.uniform1uiv(this.addr,e)}function yS(s,e){s.uniform2uiv(this.addr,e)}function MS(s,e){s.uniform3uiv(this.addr,e)}function SS(s,e){s.uniform4uiv(this.addr,e)}function TS(s,e,t){const n=this.cache,i=e.length,r=_c(t,i);Jt(n,r)||(s.uniform1iv(this.addr,r),Qt(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||Om,r[o])}function ES(s,e,t){const n=this.cache,i=e.length,r=_c(t,i);Jt(n,r)||(s.uniform1iv(this.addr,r),Qt(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||Bm,r[o])}function bS(s,e,t){const n=this.cache,i=e.length,r=_c(t,i);Jt(n,r)||(s.uniform1iv(this.addr,r),Qt(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||km,r[o])}function wS(s,e,t){const n=this.cache,i=e.length,r=_c(t,i);Jt(n,r)||(s.uniform1iv(this.addr,r),Qt(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||Fm,r[o])}function AS(s){switch(s){case 5126:return lS;case 35664:return cS;case 35665:return uS;case 35666:return hS;case 35674:return fS;case 35675:return dS;case 35676:return pS;case 5124:case 35670:return mS;case 35667:case 35671:return gS;case 35668:case 35672:return _S;case 35669:case 35673:return vS;case 5125:return xS;case 36294:return yS;case 36295:return MS;case 36296:return SS;case 35678:case 36198:case 36298:case 36306:case 35682:return TS;case 35679:case 36299:case 36307:return ES;case 35680:case 36300:case 36308:case 36293:return bS;case 36289:case 36303:case 36311:case 36292:return wS}}class RS{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=aS(t.type)}}class CS{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=AS(t.type)}}class PS{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(e,t[a.id],n)}}}const su=/(\w+)(\])?(\[|\.)?/g;function jd(s,e){s.seq.push(e),s.map[e.id]=e}function DS(s,e,t){const n=s.name,i=n.length;for(su.lastIndex=0;;){const r=su.exec(n),o=su.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){jd(t,c===void 0?new RS(a,s,e):new CS(a,s,e));break}else{let h=t.map[a];h===void 0&&(h=new PS(a),jd(t,h)),t=h}}}class kl{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);DS(r,o,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function Zd(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const LS=37297;let IS=0;function US(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const Jd=new tt;function NS(s){mt._getMatrix(Jd,mt.workingColorSpace,s);const e=`mat3( ${Jd.elements.map(t=>t.toFixed(4))} )`;switch(mt.getTransfer(s)){case jl:return[e,"LinearTransferOETF"];case Tt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Qd(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+r+`

`+US(s.getShaderSource(e),a)}else return r}function OS(s,e){const t=NS(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function FS(s,e){let t;switch(e){case X_:t="Linear";break;case Y_:t="Reinhard";break;case q_:t="Cineon";break;case K_:t="ACESFilmic";break;case j_:t="AgX";break;case Z_:t="Neutral";break;case $_:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ml=new z;function BS(){mt.getLuminanceCoefficients(ml);const s=ml.x.toFixed(4),e=ml.y.toFixed(4),t=ml.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function qS(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===im?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===E_?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===sr&&(e="SHADOWMAP_TYPE_VSM"),e}function KS(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case po:case mo:e="ENVMAP_TYPE_CUBE";break;case pc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function $S(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case mo:e="ENVMAP_MODE_REFRACTION";break}return e}function jS(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Hh:e="ENVMAP_BLENDING_MULTIPLY";break;case G_:e="ENVMAP_BLENDING_MIX";break;case W_:e="ENVMAP_BLENDING_ADD";break}return e}function ZS(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function JS(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=qS(t),c=KS(t),u=$S(t),h=jS(t),f=ZS(t),d=kS(t),_=zS(r),g=i.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
}`,ew="./";bi.registerPlugin(ft,Rs);const p_=Rs.create({wrapper:"#smooth-wrapper",content:"#smooth-content",smooth:1.5,effects:!0});p_.scrollTo(0,!0);p_.paused(!0);const kh=document.querySelector(".scroll-indicator");let tm=!1;const Sc=new Dm;Sc.onLoad=()=>{tm||(tm=!0,window.parent.postMessage({type:"threejs-scene-loaded"},"*"),console.log("loading complete"))};Sc.onProgress=(s,e,t)=>{const n=Math.round(e/t*100);window.parent.postMessage({type:"threejs-scene-progress",progress:n},"*"),console.log(`loading ${n}% (${e}/${t})`)};const ri=new ev;ri.background=new Xe(0);const tw=new rf(300,300,15),nw=new Ki({side:Dn,uniforms:{topColor:{value:new Xe(0)},bottomColor:{value:new Xe(16777215)},gradientSharpness:{value:8},gradientOffset:{value:-.05}},vertexShader:Jb,fragmentShader:Qb}),iw=new Pn(tw,nw);ri.add(iw);const rw=new Dv(16777215,.5);ri.add(rw);const yr=new af(16774893,400);yr.position.set(0,8,15);yr.angle=Math.PI/6;yr.penumbra=.2;yr.decay=2;yr.distance=30;yr.castShadow=!0;yr.target.position.set(0,.5,0);ri.add(yr.target);ri.add(yr);const ti=new z(0,14,-170),Mr=new af(16774893,2500);Mr.position.set(ti.x,ti.y+8,ti.z+2);Mr.angle=Math.PI/2;Mr.penumbra=.2;Mr.decay=2;Mr.distance=30;Mr.castShadow=!0;Mr.target.position.set(ti.x,ti.y,ti.z);ri.add(Mr.target);ri.add(Mr);const Bf=new Um(16774893,400);Bf.position.set(0,15,15);Bf.castShadow=!0;ri.add(Bf);const sw=new AT(Sc);sw.load("https://cdn.jsdelivr.net/gh/trivettegiacomo/dwg-three@44273558ff40b8e17f0ee28ceb5b102c88eabfb9/gltf/frame_wall.glb",s=>{s.scene.traverse(e=>{e.isMesh&&(e.name==="wall"&&(e.receiveShadow=!0),e.name==="frame"&&(e.castShadow=!0),e.name==="passpartout"&&(e.receiveShadow=!0),(e.name==="mount"||e.name==="mount001")&&(e.castShadow=!0))}),s.scene.position.set(0,0,0),ri.add(s.scene)},void 0,s=>{console.error("Errore nel caricamento del modello:",s)});const kf=new Xr(window.innerWidth,window.innerHeight,{minFilter:Cn,magFilter:Cn,format:Xh}),Ui=new dn(75,window.innerWidth/window.innerHeight,.1,1e3),ow=new Dr(new z(0,1,0),4),zf=new Ki({fragmentShader:jb,vertexShader:Zb,transparent:!0,uniforms:{uTime:{value:0},uFrequency:{value:.1},uAmplitude:{value:.6},uReflectionTexture:{value:kf.texture},textureMatrix:{value:new $e}}}),m_=new Po(300,300,1024,1024);m_.rotateX(-Math.PI*.5);const ya=new Pn(m_,zf);ya.position.set(0,-4,-150.85);ri.add(ya);function aw(){const s=ya.position.y;Wi.position.clone(),Wi.rotation.clone(),Ui.position.copy(Wi.position),Ui.position.y=2*s-Wi.position.y,Ui.lookAt(ti.x,ti.y,ti.z),Ui.updateMatrixWorld(),Ui.updateProjectionMatrix();const e=new $e;e.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),e.multiply(Ui.projectionMatrix),e.multiply(Ui.matrixWorldInverse),zf.uniforms.textureMatrix.value=e,ya.visible=!1,wi.clippingPlanes=[ow],wi.setRenderTarget(kf),wi.render(ri,Ui),wi.setRenderTarget(null),wi.clippingPlanes=[],ya.visible=!0}const lw=new Im(Sc).load(`${ew}textures/cloud.png`),Tc=new qb({texture:lw});Tc.position.set(ti.x,ti.y,ti.z);ri.add(Tc);const cw=new $b({seed:5,segments:80,volume:10,bounds:new z(12,4,2),opacity:.7,speed:.2,color:new Xe("white")});Tc.add(cw);let fc=ti.z+35;const uw=10,hw=6e3;window.innerWidth<768&&(fc+=4);const Wi=new dn(75,window.innerWidth/window.innerHeight,.1,1e3);Wi.position.set(.1,0,fc);const Hf=document.createElement("div");Hf.className="spacer";Hf.style.height="calc(100vh + "+hw+"px)";document.getElementById("smooth-content").appendChild(Hf);const wi=new wT({antialias:!0});wi.setSize(window.innerWidth,window.innerHeight);wi.shadowMap.enabled=!0;wi.domElement.id="webgl";document.body.appendChild(wi.domElement);const nm=new Uv;function g_(){const s=nm.getElapsedTime(),e=nm.getDelta();zf.uniforms.uTime.value=s,aw(),requestAnimationFrame(g_),Tc.update(Wi,s,e),wi.render(ri,Wi)}g_();window.addEventListener("resize",()=>{Wi.aspect=window.innerWidth/window.innerHeight,Wi.updateProjectionMatrix(),wi.setSize(window.innerWidth,window.innerHeight),kf.setSize(window.innerWidth,window.innerHeight),Ui.aspect=window.innerWidth/window.innerHeight,Ui.updateProjectionMatrix()});function fw(s){const e=Array.from(s.childNodes);s.textContent="",e.forEach(t=>{if(t.nodeType===Node.TEXT_NODE)t.textContent.split(/(\s+)/).forEach(i=>{if(i.match(/^\s+$/))s.appendChild(document.createTextNode(i));else if(i.trim()!==""){const r=document.createElement("span");r.textContent=i,s.appendChild(r)}});else if(t.nodeType===Node.ELEMENT_NODE){const n=t.cloneNode(!1);t.textContent.split(/(\s+)/).forEach(r=>{if(r.match(/^\s+$/))n.appendChild(document.createTextNode(r));else if(r.trim()!==""){const o=document.createElement("span");o.textContent=r,n.appendChild(o)}}),s.appendChild(n)}})}let Xi=1,Vf=1,Ba=!0;window.addEventListener("load",()=>{const s=document.querySelector(".intro1"),e=document.querySelector(".intro2"),t=document.querySelector(".intro3");[s,e,t].forEach(n=>fw(n)),bi.set(".intro1 span, .intro2 span, .intro3 span",{opacity:0}),bi.set(".intro1, .intro2, .intro3",{opacity:1})});window.addEventListener("message",s=>{s.data?.type==="start-scene-animation"&&(console.log("received start"),bi.to(".intro1 span",{opacity:1,duration:1,stagger:.15,delay:.5,ease:"power1.out",onComplete:function(){console.log("span animation complete"),bi.to(kh,{opacity:1,duration:.5,onComplete:()=>{Ba=!1,console.log("enabling scroll")}})}}))});const dw=1,zh=3;function __(){console.log("Going to phase: ",Xi),Ba=!0,bi.to(kh,{opacity:0,duration:.5}),bi.to(".intro"+Vf+" span",{opacity:0,duration:1});const s=fc+(Xi-1)/(zh-1)*(uw-fc);bi.to(Wi.position,{z:s,duration:3,ease:"power1.inOut",onComplete:()=>{bi.to(".intro"+Xi+" span",{opacity:1,duration:1.5,delay:0,stagger:.15,onComplete:()=>{Xi===zh&&(window.parent.postMessage({type:"iframeScrolledToEnd"},"*"),console.log("iframeScrolledToEnd message")),bi.to(kh,{opacity:1,duration:.5,onComplete:()=>{Ba=!1}})}})}})}function v_(){Xi<zh&&(Vf=Xi,Xi++,__())}function x_(){Xi>dw&&(Vf=Xi,Xi--,__())}window.addEventListener("wheel",s=>{Ba||(s.deltaY>0?(console.log("scroll verso il basso"),v_()):s.deltaY<0&&(console.log("scroll verso l’alto"),x_()))});let y_=0,M_=0;window.addEventListener("touchstart",s=>{y_=s.touches[0].clientY});window.addEventListener("touchend",s=>{M_=s.changedTouches[0].clientY,pw()});function pw(){const s=y_-M_;Math.abs(s)<50||Ba||(s>0?(console.log("swipe verso l’alto"),v_()):(console.log("swipe verso il basso"),x_()))}
